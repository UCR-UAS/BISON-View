...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_mission_t, stringdata) + ofs \
...
const QMetaObject mission::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_mission.data,
      qt_meta_data_mission,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mission.stringdata))
